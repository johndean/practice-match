...
# committed WebP files from seeds/hospitals/photos/. ~2.3 MiB (76 files, of which 73 are
# photographs — A-L10 leaves 35 of the design's 108 photo slots empty on purpose).
COPY seeds/ ./seeds/
