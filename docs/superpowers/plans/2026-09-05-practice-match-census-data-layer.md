...
**Owed and NOT part of this.** Growth cannot become per-neighbourhood until the 2010→2020 tract crosswalk is loaded, which is the registered Phase C deferral in the table above. And the THIRD false sentence — the Browse "Market data" card's "Figures describe the community around each practice…", guarded by no amendment at all — is **not** corrected here: D-C39 names two sentences, not three. It is left as its own ruling rather than silently widened.
