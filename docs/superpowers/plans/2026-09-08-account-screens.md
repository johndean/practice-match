...
**Files:**
- Modify: `frontend/src/router/routes.ts`, `frontend/src/router/sync.ts`, `frontend/src/router/sync.test.ts`, `frontend/src/router/useStateRouteSync.test.ts`, `frontend/tests/smoke.spec.ts` (the `ROUTES` list of the signed-out render test)
