...
|---|---|
| Date | 2026-09-05 |
| Status | DONE 2026-09-06 — every task delivered and merged to main; live on qa.foundation.vin (marketplace) and foundation.vin (Coming Soon mode; the marketplace launches there with a `SITE_MODE` flip) |
| Owner | John Dean |
