    ...
    <template v-if="v.showGate">
      <div>
        <div style="padding: 46px 34px; background: var(--rf-band);">
          <h1 style="font-family: var(--rf-display); font-size: 40px; font-weight: 800; color: var(--color-navy); margin: 0;">Veterinary Practice Transitions</h1>
        </div>
        <div style="max-width: 1180px; margin: 0 auto; padding: 62px 34px 80px; display: grid; grid-template-columns: 1.15fr .85fr; gap: 60px; align-items: start;">
          <div>
            <h2 style="font-family: var(--rf-display); font-size: 30px; font-weight: 800; line-height: 1.25; color: var(--color-navy); margin: 0;">We're here to help connect veterinary practice owners with colleagues who want to purchase and carry the practice forward</h2>
          ...
          <div>
            <template v-if="v.gateSignin">
              <div style="background: var(--color-white); border: 1px solid var(--rf-line); border-radius: 10px; box-shadow: var(--shadow-md); overflow: hidden;">
                <div style="padding: 22px 26px; background: var(--rf-band);">
                  <div style="font-family: var(--rf-display); font-size: 20px; font-weight: 800; color: var(--color-navy);">Member Sign In</div>
            ...
            <template v-if="v.gateApply">
              <div style="background: var(--color-white); border: 1px solid var(--rf-line); border-radius: 10px; box-shadow: var(--shadow-md); overflow: hidden;">
                <div style="padding: 22px 26px; background: var(--rf-band);">
                  <div style="font-family: var(--rf-display); font-size: 20px; font-weight: 800; color: var(--color-navy);">Request Access</div>
            ...
            <template v-if="v.gateStatus">
              <div style="background: var(--color-white); border: 1px solid var(--rf-line); border-radius: 10px; box-shadow: var(--shadow-md); overflow: hidden;">
                <div :style="v.status?.headStyle">
                  ...
                  <div style="font-family: var(--rf-display); font-size: 22px; font-weight: 800; margin-top: 5px;"><span v-if="__s(v.status?.title) !== null" class="sc-interp">{{ __s(v.status?.title) }}</span></div>
                </div>
        ...
        <div style="background: var(--color-navy); color: var(--color-white); padding: 30px 34px;">
          <div style="max-width: 1180px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between; gap: 28px; flex-wrap: wrap;">
            <div style="display: flex; align-items: center; gap: 18px;">
              ...
              <div style="font-family: var(--rf-display); font-size: 24px; font-weight: 800; line-height: 1.3;">New to ownership? Start with the StartUp Club.</div>
            </div>
        ...
        <div style="flex: 1; display: flex; min-height: 300px; border-bottom: 1px solid #e6e6e6; overflow-x: auto;">
          ...
          <div class="rf-scroll" :style="v.md?.railStyle">
            <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; padding: 16px 16px 10px;">
              <div>
                <div style="font-family: var(--rf-display); font-size: 20px; font-weight: 800; letter-spacing: -.005em; color: var(--vf-navy); line-height: 1.2;"><span v-if="__s(v.md?.mdHeadline) !== null" class="sc-interp">{{ __s(v.md?.mdHeadline) }}</span></div>
      ...
      <div>
        <div style="padding: 28px 34px; background: var(--rf-band);">
          <div style="max-width: 1180px; margin: 0 auto;">
            ...
            <h1 style="font-family: var(--rf-display); font-size: 34px; font-weight: 800; color: var(--color-navy); margin: 12px 0 0;"><span v-if="__s(v.d?.title) !== null" class="sc-interp">{{ __s(v.d?.title) }}</span></h1>
        ...
        <div style="max-width: 1180px; margin: 0 auto; padding: 34px 34px 70px; display: grid; grid-template-columns: 1fr 372px; gap: 44px; align-items: start;">
          <div style="min-width: 0; display: flex; flex-direction: column; gap: 34px;">
            ...
            <template v-for="(sec, $index) in __arr(v.d?.sections)" :key="$index">
              <div>
                <h2 style="font-family: var(--rf-display); font-size: 21px; font-weight: 800; color: var(--color-navy); margin: 0 0 4px;"><span v-if="__s(sec?.title) !== null" class="sc-interp">{{ __s(sec?.title) }}</span></h2>
            ...
            <div>
              <h2 style="font-family: var(--rf-display); font-size: 21px; font-weight: 800; color: var(--color-navy); margin: 0 0 4px;">Photos and Documents</h2>
              <div style="height: 3px; width: 46px; background: var(--color-blue); margin-bottom: 18px;"></div>
            ...
            <div>
              <h2 style="font-family: var(--rf-display); font-size: 21px; font-weight: 800; color: var(--color-navy); margin: 0 0 4px;">Community Context</h2>
              <div style="height: 3px; width: 46px; background: var(--color-blue); margin-bottom: 18px;"></div>
                  ...
                  <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px;">
                    <template v-for="(m, $index) in __arr(v.d?.demo)" :key="$index">
                      <div style="padding: 18px 16px; background: var(--rf-band); border-radius: 10px;">
                        ...
                        <div style="font-family: var(--rf-display); font-size: 24px; font-weight: 800; color: var(--color-navy); margin-top: 7px; line-height: 1.15;"><span v-if="__s(m?.v) !== null" class="sc-interp">{{ __s(m?.v) }}</span></div>
          ...
          <div style="position: fixed; inset: 0; z-index: 900; background: rgba(0,58,112,.55); display: grid; place-items: center; padding: 24px;">
            <div style="width: 100%; max-width: 520px; background: var(--color-white); border-radius: 12px; box-shadow: var(--shadow-xl); overflow: hidden; animation: rf-fade-up 300ms var(--easing-out) both;">
              <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; padding: 22px 26px; background: var(--rf-band);">
                <div>
                  <div style="font-family: var(--rf-display); font-size: 20px; font-weight: 800; color: var(--color-navy);"><span v-if="__s(v.modal?.title) !== null" class="sc-interp">{{ __s(v.modal?.title) }}</span></div>
      ...
      <div>
        <div style="padding: 40px 34px; background: var(--rf-band);">
          <div style="max-width: 1000px; margin: 0 auto;">
            <h1 style="font-family: var(--rf-display); font-size: 36px; font-weight: 800; color: var(--color-navy); margin: 0;">My Requests</h1>
        ...
        <div style="max-width: 1000px; margin: 0 auto; padding: 34px 34px 70px; display: flex; flex-direction: column; gap: 14px;">
          ...
          <template v-if="v.noRequests">
            <div style="padding: 54px 26px; text-align: center; background: var(--color-off-white); border: 1px solid var(--rf-line); border-radius: 10px;">
              <div style="font-family: var(--rf-display); font-size: 19px; font-weight: 800; color: var(--color-navy);">No requests yet</div>
      ...
      <div>
        <div style="padding: 40px 34px; background: var(--rf-band);">
          <div style="max-width: 1120px; margin: 0 auto; display: flex; align-items: flex-end; justify-content: space-between; gap: 24px; flex-wrap: wrap;">
            <div>
              <h1 style="font-family: var(--rf-display); font-size: 36px; font-weight: 800; color: var(--color-navy); margin: 0;"><span v-if="__s(v.seller?.heading) !== null" class="sc-interp">{{ __s(v.seller?.heading) }}</span></h1>
        ...
        <template v-if="v.seller?.isDash">
          <div style="max-width: 1120px; margin: 0 auto; padding: 34px 34px 70px; display: grid; grid-template-columns: 1.35fr 1fr; gap: 40px; align-items: start;">
            <div>
              <h2 style="font-family: var(--rf-display); font-size: 19px; font-weight: 800; color: var(--color-navy); margin: 0 0 4px;">My Listings</h2>
            ...
            <div>
              <h2 style="font-family: var(--rf-display); font-size: 19px; font-weight: 800; color: var(--color-navy); margin: 0 0 4px;">Buyer Interest</h2>
              <div style="height: 3px; width: 44px; background: var(--color-blue); margin-bottom: 18px;"></div>
              <div style="display: flex; flex-direction: column; gap: 12px;">
              ...
              <template v-if="v.wiz?.isForm">
                <div style="background: var(--color-white); border: 1px solid var(--rf-line); border-radius: 10px; box-shadow: var(--shadow-md); overflow: hidden;">
                  <div style="padding: 22px 26px; border-bottom: 1px solid var(--rf-line);">
                    <div style="font-family: var(--rf-display); font-size: 22px; font-weight: 800; color: var(--color-navy);"><span v-if="__s(v.wiz?.title) !== null" class="sc-interp">{{ __s(v.wiz?.title) }}</span></div>
              ...
              <template v-if="v.wiz?.isPreview">
                <div style="background: var(--color-white); border: 1px solid var(--rf-line); border-radius: 10px; box-shadow: var(--shadow-md); overflow: hidden;">
                  <div style="padding: 20px 26px; background: var(--rf-band);">
                    ...
                    <div style="font-family: var(--rf-display); font-size: 24px; font-weight: 800; color: var(--color-navy); margin-top: 6px;"><span v-if="__s(v.wiz?.previewTitle) !== null" class="sc-interp">{{ __s(v.wiz?.previewTitle) }}</span></div>
                  </div>
                  <div style="padding: 24px 26px 26px;">
              ...
              <template v-if="v.wiz?.isDone">
                <div style="background: var(--color-white); border: 1px solid var(--rf-line); border-radius: 10px; box-shadow: var(--shadow-md); overflow: hidden;">
                  <div style="padding: 24px 26px; background: #deecf7;">
                    ...
                    <div style="font-family: var(--rf-display); font-size: 24px; font-weight: 800; color: #003a70; margin-top: 5px;">Your listing is with the VIN Foundation</div>
                  </div>
                  <div style="padding: 24px 26px 26px;">
    ...
    <template v-if="v.isAdmin">
      <div>
        <div style="padding: 40px 34px 0; background: var(--rf-band);">
          <div style="max-width: 1180px; margin: 0 auto;">
            <h1 style="font-family: var(--rf-display); font-size: 36px; font-weight: 800; color: var(--color-navy); margin: 0;">VIN Foundation Admin</h1>
      ...
      <div style="width: 390px; height: 800px; display: flex; flex-direction: column; background: var(--color-white); border-radius: 26px; box-shadow: var(--shadow-xl); overflow: hidden; border: 1px solid var(--rf-line);">
        ...
        <template v-if="v.mob?.isDetail">
          <div class="rf-scroll" style="flex: 1; overflow-y: auto; min-height: 0; padding-bottom: 80px;">
            ...
            <div style="padding: 16px;">
              <div style="font-family: var(--rf-display); font-size: 19px; font-weight: 800; line-height: 1.25; color: var(--color-navy);"><span v-if="__s(v.d?.title) !== null" class="sc-interp">{{ __s(v.d?.title) }}</span></div>
