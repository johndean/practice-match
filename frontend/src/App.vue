        ...
        <div style="flex: none; background: var(--vf-white); border-top: 1px solid #e6e6e6;">
          ...
          <template v-if="v.md?.stripOpen">
            <div class="rf-scroll" style="max-height: 40vh; overflow-y: auto; padding: 0 22px 16px;">
              ...
              <p style="margin: 12px 0 0; font-size: 10.5px; line-height: 1.55; color: #767676; max-width: 96ch;">Three kinds of figure appear here and they measure different things. A Census tract figure is the Census’s own published estimate for that one tract. A practice’s figure is derived from the tracts within about 5 miles of it. A metro figure is the Census’s own published figure for the metro where it publishes one, and otherwise is built from the metro’s own Census areas, as the card says. In AREA mode each card is that metro figure and its own caption says which of the two it is, with the bars beneath it the distribution across the metro’s Census tracts, places, counties or ZIP areas; with a practice selected each card is that practice’s own figure, captioned with the geography it is measured for. Pet-household counts and average practice payroll are derived estimates, not observed values. Population growth is measured for the surrounding city or county, not the tract.</p>
            </div>
          </template>
