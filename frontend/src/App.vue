        ...
        <div style="flex: none; background: var(--vf-white); border-top: 1px solid #e6e6e6;">
          ...
          <template v-if="v.md?.stripOpen">
            <div class="rf-scroll" style="max-height: 40vh; overflow-y: auto; padding: 0 22px 16px;">
              ...
              <p style="margin: 12px 0 0; font-size: 10.5px; line-height: 1.55; color: #767676; max-width: 96ch;">Figures describe the area around each practice, not the practice itself. Pet-household counts and average practice payroll are derived estimates, not observed values. The map shades Census tracts, places, counties or ZIP Code Tabulation Areas, as each layer’s legend names; the snapshot’s figures describe the area around each practice, not the practice itself.</p>
            </div>
          </template>
