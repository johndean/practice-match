    ...
    return {
      ...
      inbox: inbox.map((r) => {
        ...
        return {
          ...
          resolvedNote: r.status === "accepted" ? "You released the financial packet and floor plan to this buyer." : r.status === "revoked" ? "You withdrew this buyer's access. The buyer no longer sees the financial packet or floor plan." : "You declined this request. The buyer was told you are not engaging further.",
