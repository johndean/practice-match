...
// D-I8-8) — the other four keep their hashes, because the account those screens are captured as
// is a buyer whose computed label IS the fixture's. Read by baseline-manifest.test.ts: a moved
