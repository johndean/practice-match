...
INSERT INTO dataset_registry
  ...
  ('zbp','ZIP Code Business Patterns','2022/cbp','https://api.census.gov/data','2022','NAICS2017','Annual (Apr)','cleared','Public domain','https://www.census.gov/data/developers/about/terms-of-service.html','Source: U.S. Census Bureau, ZIP Code Business Patterns, 2022','Plan decision D11 — community-level competition counts; ZIP codes treated as ZCTAs (approximation labelled in the UI). Controller amendment A-C6: the standalone zbp dataset ends at vintage 2018; ZIP-level Business Patterns from 2019 are served by the CBP endpoint''s "zip code" geography (verified 2026-09-09 against api.census.gov/data/2022/cbp/geography.json); loaded nationally once per NAICS code and kept for the market states'' ZCTAs present in geo_area.'),
