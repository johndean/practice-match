...
INSERT INTO dataset_registry
  ...
  ('esri_tiles','Base map and tiles (Esri Light Gray Canvas)','Canvas/World_Light_Gray_Base + Canvas/World_Light_Gray_Reference','https://server.arcgisonline.com/ArcGIS/rest/services','live',NULL,'Live tiles','unresolved',NULL,'https://www.esri.com/en-us/legal/terms/master-agreement','Tiles © Esri','The basemap every map in the product draws. Registered as unresolved pending the VIN Foundation''s decision under the Census plan''s "Basemap licence — one decision record" (Esri, the approved design, vs CARTO, the Census spec). Do not clear this row without that decision.'),
  ('esri_imagery','Satellite imagery (Esri World Imagery)','World_Imagery','https://server.arcgisonline.com/ArcGIS/rest/services','live',NULL,'Live tiles','unresolved',NULL,'https://www.esri.com/en-us/legal/terms/master-agreement','Source: Esri, Vantor, Earthstar Geographics, and the GIS User Community','What the Browse map''s Satellite toggle draws. Registered as unresolved pending the VIN Foundation''s decision under the same one basemap decision record; the toggle is not gated on this row, which is recorded as a design blocker rather than decided here.');
